    ...
    return (
        <Layout>
            <StBodyWrap>
                <StInputWrap>
                    <div>회원가입</div>
                    <div><StInput type="text" data-testid="email-input" name="email" onChange={joinDataHandle} value={joinData.email || ""} placeholder="Email형식 아이디" /></div>
                    ...
                    <div><StInput type="password" data-testid="password-input" name="password" onChange={joinDataHandle} value={joinData.password || ""} placeholder="비밀번호 8자 이상" /></div>
                    ...
                    <div><StInput type="password" data-testid="password-input" name="matchPassword" onChange={joinDataHandle} value={joinData.matchPassword || ""} placeholder="비밀번호 확인" /></div>
                ...
                <StButtonWrap>
                    <StButton data-testid="signup-button" color="#ffff" backgroundColor="#F0A4BD" onClick={join} disabled={joinDisabled}>가입하기</StButton>
                    <StButton color="#ffff" backgroundColor="#F0A4BD" onClick={cansleJoin}>취소</StButton>
                </StButtonWrap>
            </StBodyWrap>
        </Layout>
    );
